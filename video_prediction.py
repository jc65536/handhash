...
model = create_mlp_model(63, 59, 0.005, 37)
# model.compile(optimizer=optimizer, loss='sparse_categorical_crossentropy', metrics=['accuracy'])
model.load_weights('mlp_True_0.500000e-3_bs32.h5')  # Assuming the weights are saved in this file.
...
classification_names = ['1', '2', '3', '3_hook', '4', '5', '6', '7', '8', 'a',
                      'b', 'b_nothumb', 'b_thumb', 'cbaby', 'obaby', 'by/spoon', 'c', 'd', 'e', 'f',
                      'f_open', 'fly', 'fly_nothumb', 'g', 'h', 'h_hook', 'h_thumb', 'i', 'jesus', 'k',
                      'l_hook', 'middle', 'm/m2', 'n', 'o', 'index', 'index_flex', 'index_hook', 'pincet', 'ital',
                      'ital_thumb', 'ital_nothumb', 'ital_open', 'r', 's', 'write', 't', 'v', 'v_flex',
                      'v_hook', 'v_thumb', 'w', 'y', 'ae', 'ae_thumb', 'pincet_double', 'obaby_double', 'jesus_thumb',
                      'No Gesture']
...
#  hierarchy_inferencer = HierarchyInferencer('hierarchies/confusion_based')
